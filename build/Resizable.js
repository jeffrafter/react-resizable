...
var Resizable = function (_React$Component) {
  ...
  Resizable.prototype.resizeHandler = function resizeHandler(handlerName) {
    ...
    return function (e, _ref2) {
      ...
      var invert = _this2.props.dir === 'invert' ? -1 : 1;

      // Update w/h
      var width = _this2.state.width + (canDragX ? deltaX : 0) * invert;
      var height = _this2.state.height + (canDragY ? deltaY : 0) * invert;
  ...
  Resizable.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        p = _objectWithoutProperties(_props, ['children', 'draggableOpts', 'width', 'height', 'handleSize', 'lockAspectRatio', 'axis', 'dir', 'minConstraints', 'maxConstraints', 'onResize', 'onResizeStop', 'onResizeStart']);
...
Resizable.propTypes = {
  ...
  // Reverses the direction of resizing so the handle can move
  // 'default' - resizing increases the size of the component
  // 'invert' - resizing descreases the size of the component
  dir: _propTypes2.default.oneOf(['default', 'invert']),
